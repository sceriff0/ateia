/*
 * REG_COMPOSE_MICRO - distributed registration, SEPARATED-mode finalize WITH micro second wave
 *
...
process REG_COMPOSE_MICRO {
    ...
    echo "${task.process},${patient_id},${slide},\${in_bytes:-0}" > ${patient_id}_${slide}.REG_COMPOSE_MICRO.size.csv
    ...
    """
    touch slide_dxdy.v
    echo "STUB,${patient_id},${slide},0" > ${patient_id}_${slide}.REG_COMPOSE_MICRO.size.csv
    cat <<-END_VERSIONS > versions.yml
    "${task.process}":
        python: stub
        valis: stub
