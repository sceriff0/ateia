...
workflow ADD_CYCLE {
    ...
    //    harmless placeholder — EXPORT_GEOJSON's arg guard
    //    (params.panel_spec || params.panel_model) suppresses those args, so
    //    add_cycle keeps its legacy constant-"Cell" export unchanged.
    // ------------------------------------------------------------------ //
