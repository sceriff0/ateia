...
Use the `results/csv/preprocessed.csv` generated by the preprocessing step, or construct an equivalent file manually.
...
Use the `results/csv/registered.csv` generated by the registration step, or construct an equivalent file manually.
