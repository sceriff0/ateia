/**
 * ============================================================================
 * QUPATH SCRIPT: Import GeoJSON Detections
 * ============================================================================
 *
 * Imports cells from GeoJSON with measurements (marker intensities, morphology).
 * Designed for use with the Gate Tree extension — stores measurements with
 * raw names (no layer prefix) for direct channel matching.
 *
 * FEATURES:
 ...
 *   - Load classification colors from .classifications.json if present
 *
 * USAGE:
...
println "=" * 60
println "QuPath GeoJSON Import (Gate Tree compatible)"
println "=" * 60
...
// Load classification colors if available
...
features.eachWithIndex { featureElement, idx ->
    try {
        ...
        // Classification (optional — Gate Tree will override)
